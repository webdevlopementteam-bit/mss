...
export default function OrdersView() {
  ...
  const [expanded, setExpanded] = useState(null); 
   ...
   const [filter, setFilter] = useState(searchParams.get("filter") || "total");  
  ...
  const filteredOrders = useMemo(() => {
    if (filter === "total") return orders;
    return orders.filter((o) => getOrderCategory(o.orderStatus) === filter);
  }, [orders, filter]);
          ...
          return (
            <button
              ...
              style={{
                ...
                padding: "6px 14px",
                borderRadius: 99,
                background: isActive ? C.red : "#f3f4f6",
            ...
            >
              {label}{" "}
              <b style={{ color: isActive ? "#fff" : C.red }}>{count}</b>
            </button>
          );
        })}
      </div>
  ...
  {filteredOrders.length === 0 ? (
    ...
    filteredOrders.map((o) => {
          ...
          const itemCount = (o.orderItems || []).reduce(
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", gap: 16, marginTop: 4 }}>
                      <span style={{ fontSize: 12, color: C.muted }}>
                        Qty: <b style={{ color: C.text }}>{itemCount}</b>
                      </span>
                      <span
                        ...
                        {o.trackingId && (
                          <button
                            onClick={() => {
                              ...
                              showToast(
                                "Tracking ID copied — paste it on the DTDC tracking page.",
                              );
                            }}
                            style={{
                              display: "inline-flex",
